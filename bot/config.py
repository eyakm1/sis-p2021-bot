...
TIMEOUT_INTERVAL_SECONDS = float(os.getenv("TIMEOUT_INTERVAL_SECONDS", "20"))
HEARTBEAT_INTERVAL_SECONDS = 3 * TIMEOUT_INTERVAL_SECONDS
NETWORK_ERROR_SLEEP = float(os.getenv("NETWORK_ERROR_SLEEP", "20"))
